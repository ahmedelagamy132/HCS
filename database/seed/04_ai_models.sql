...
INSERT INTO ai_analyses (model_id, horse_id, analysis_type, status, confidence_score, processing_ms, triggered_by, result) VALUES
  -- Health analyses
  ('f0000001-0000-0000-0000-000000000001','f0000001-0000-0000-0000-000000000001','health','completed',97.2,  780,'system','{"health_score":96.2,"status":"excellent","flags":[]}'),
  ('f0000001-0000-0000-0000-000000000001','f0000001-0000-0000-0000-000000000008','health','completed',96.2,  810,'system','{"health_score":22.4,"status":"critical","flags":["fever","tachycardia","dehydration"]}'),
  ('f0000001-0000-0000-0000-000000000001','f0000001-0000-0000-0000-000000000007','health','completed',91.7,  830,'system','{"health_score":61.2,"status":"fair","flags":["weight_loss","reduced_gut_sounds"]}'),
  -- Disease detection
  ('f0000001-0000-0000-0000-000000000005','f0000001-0000-0000-0000-000000000008','disease','completed',96.2, 1920,'system','{"conditions":[{"name":"febrile_illness","probability":0.962},{"name":"viral_infection","probability":0.741}],"alert_raised":true}'),
  -- Gait analyses
  ('f0000001-0000-0000-0000-000000000002','f0000001-0000-0000-0000-000000000007','gait',  'completed',84.1, 1380,'system','{"symmetry_score":71.0,"lameness_detected":true,"lameness_grade":1,"affected_limbs":["LF"]}'),
  ('f0000001-0000-0000-0000-000000000002','f0000001-0000-0000-0000-000000000001','gait',  'completed',95.8, 1350,'system','{"symmetry_score":97.2,"lameness_detected":false}'),
  -- Diet
  ('f0000001-0000-0000-0000-000000000004','f0000001-0000-0000-0000-000000000007','diet',  'completed',88.3,  590,'system','{"daily_calories":18500,"protein_pct":12,"fat_pct":4,"fiber_pct":38,"recommendation":"increase_forage_reduce_concentrate"}'),
  -- Behavior
  ('f0000001-0000-0000-0000-000000000003','f0000001-0000-0000-0000-000000000008','behavior','completed',87.4, 1080,'system','{"stress_level":9,"appetite_score":2,"activity_level":"distressed","notable_behaviors":["box_walking","refusing_feed","pawing"]}');
